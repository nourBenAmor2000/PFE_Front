        ...
        <swiper-slide v-for="property in properties" :key="property.id">
          <div class="property-card">
            ...
            <div class="property-image">
              ...
              <div class="featured-badge" v-if="property.featured">FEATURED</div>
            ...
            <div class="property-details">
              ...
              <div class="property-features">
                ...
                <div class="feature">
                  ...
                  <span class="feature-label">sqft</span>
                </div>
              </div>
              ...
              <div class="property-footer">
                ...
                <div class="property-actions">
                  <button class="action-btn" @click="toggleFavorite(property.id)">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                            d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                    </svg>
                  </button>
                  <button class="action-btn" @click="shareProperty(property.id)">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
...
const properties = ref<Property[]>([
  ...
  },
  {
    ...
    address: "789 Maple Street, Queens",
    price: 3400,
    beds: 4,
    baths: 3,
    sqft: 1800,
  ...
  },
  {
    ...
    address: "321 Fifth Avenue, Manhattan",
    price: 12000,
    beds: 5,
    baths: 4,
    sqft: 2500,
  ...
  },
  {
    ...
    address: "654 Oak Lane, Staten Island",
    price: 2800,
    beds: 2,
    baths: 1,
    sqft: 900,
  ...
  },
  {
    ...
    address: "987 Harbor View, Brooklyn",
    price: 15000,
    beds: 8,
    baths: 6,
    sqft: 4000,
...
.featured-badge {
  @apply absolute top-4 left-4 bg-red-500 text-white px-3 py-1 rounded text-sm font-medium;
}

.price-tag {
  @apply absolute bottom-4 left-4 bg-white text-gray-900 px-3 py-2 rounded font-bold text-lg shadow-md;
}
...
.property-features {
  @apply flex items-center gap-6 mb-4 pb-4 border-b border-gray-200;
}
...
.action-btn {
  @apply p-2 text-gray-500 hover:text-red-500 transition-colors duration-200;
}
