...
import { Calendar, User, Home, Save, ArrowLeft, Loader, MapPin, Phone } from 'lucide-vue-next'
...
const submit = async () => {
  ...
  try {
    ...
    await visitStore.addVisit(payload)
    router.push('/admin/visits')
  } catch (error) {
    const errorMsg = visitStore.error || error.message || 'Erreur lors de la création'
      ...
      <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <h1 class="text-3xl font-bold text-gray-900">Nouvelle Visite</h1>
              <p class="text-gray-600 mt-1">Planifiez une nouvelle visite de logement</p>
            </div>
          </div>
        </div>
          ...
          <CardContent class="p-6 bg-white">
            <form @submit.prevent="submit" class="space-y-6">
              ...
              <div class="space-y-2">
                ...
                />
                <p v-if="formattedDate" class="text-sm text-blue-600 font-medium">
                  {{ formattedDate }}
                </p>
              </div>
              ...
              <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
                ...
                >
                  <Save :size="16" />
                  <span v-if="isSubmitting">Planification...</span>
                  <span v-else>Planifier la visite</span>
                </Button>
              </div>
            </form>
          </CardContent>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <ul class="mt-1 text-sm text-blue-700 space-y-1">
                ...
                <li>• Vérifiez la disponibilité du client avant de planifier</li>
                <li>• Assurez-vous que le logement est disponible pour la visite</li>
                <li>• Contactez le client pour confirmer la visite après enregistrement</li>
              </ul>
            </div>
          </div>
        </div>
