...
// Get current category and agency details
const currentCategory = computed(() => {
  return categories.find(c => c._id === logement.value.category_id)
})

const currentAgency = computed(() => {
  return agencies.find(a => a._id === logement.value.agency_id)
})
</script>
      ...
      <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <h1 class="text-3xl font-bold text-gray-900">Modifier le Logement</h1>
              <p class="text-gray-600 mt-1">Mettez à jour les informations du logement</p>
            </div>
          </div>
        </div>
        ...
        <Card v-else class="shadow-lg border-0">
          <CardHeader class="border-b border-gray-200 bg-white">
            <CardTitle class="flex items-center gap-2 text-xl">
              ...
              <span v-if="logement.title" class="text-gray-500 font-normal text-sm">
                - {{ logement.title }}
              </span>
            </CardTitle>
          </CardHeader>
          ...
          <CardContent class="p-6 bg-white">
            <form @submit.prevent="submit" class="space-y-6">
              ...
              <div class="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <h4 class="text-sm font-medium text-blue-900 mb-3">Informations actuelles</h4>
                <div class="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span class="text-blue-700">Catégorie:</span>
                    <span class="text-blue-900 font-medium ml-2">{{ currentCategory?.name || '—' }}</span>
                  </div>
                  <div>
                    <span class="text-blue-700">Agence:</span>
                    <span class="text-blue-900 font-medium ml-2">{{ currentAgency?.name || '—' }}</span>
                  </div>
                  <div>
                    <span class="text-blue-700">Surface:</span>
                    <span class="text-blue-900 font-medium ml-2">{{ logement.surface || '—' }} m²</span>
                  </div>
                  <div>
                    <span class="text-blue-700">Étage:</span>
                    <span class="text-blue-900 font-medium ml-2">{{ logement.floor || '—' }}</span>
                  </div>
                </div>
              </div>
