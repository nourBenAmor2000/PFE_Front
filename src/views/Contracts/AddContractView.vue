        ...
        <div class="mb-8">
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-gray-600 mt-1">Créez un nouveau contrat de location</p>
            </div>
          </div>
        </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
              ...
              <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
                ...
                >
                  ...
                  <span v-else>Créer le contrat</span>
                </Button>
              </div>
            </form>
          </CardContent>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <ul class="mt-1 text-sm text-blue-700 space-y-1">
                ...
                <li>• Vérifiez la disponibilité du logement avant de créer le contrat</li>
                <li>• La date de fin doit être postérieure à la date de début</li>
                <li>• Le montant est mensuel et en TND</li>
              </ul>
            </div>
          </div>
        </div>
